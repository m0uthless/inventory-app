...
/**
 * RequirePortalPerm — guard di route che verifica un permesso Django reale
 * (stesso codename applicato lato server da PortalModelPermissions, es.
 * "device.view_device", "vlan.view_vlan", "vlan.view_vlaniprequest").
 *
 * Fix (audit 2026-07): prima tutte le pagine PORTAL erano montate solo
...
export function RequirePortalPerm({
  ...
  const granted = me.portal.permissions ?? []
