...
import PortalDevicePageDrawer from '../ui/PortalDevicePageDrawer'
...
export default function Device() {
  ...
  const canEdit = me?.portal?.can_edit_devices ?? false
  ...
  // Read-only drawer (usa PortalDeviceDrawer standalone)
