/**
 * PortalDevicePageDrawer — drawer completo per la pagina Device del portale AUSL BO.
 *
...
export type PortalPageDeviceDetail = {
  id: number
  model: string | null
  aetitle: string | null
...
export interface PortalDevicePageDrawerProps {
  open: boolean
  onClose: () => void
  detail: PortalPageDeviceDetail | null
...
export default function PortalDevicePageDrawer({
  open,
  onClose,
  detail,
  selectedId,
