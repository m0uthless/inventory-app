...
export interface PortalNewDeviceDrawerProps {
...
export default function PortalNewDeviceDrawer({ initialForm, customerId, onClose, onSaved }: PortalNewDeviceDrawerProps) {
