/**
 * PortalContactDrawer — drawer read-only per i contatti del portale AUSL BO.
...
export type PortalContactDetail = ContactReadDetail

export interface PortalContactDrawerProps {
  open: boolean
  onClose: () => void
  detail: PortalContactDetail | null
  selectedId: number | null
  detailLoading: boolean
}

export default function PortalContactDrawer({
  open,
  onClose,
  detail,
  selectedId,
  detailLoading,
}: PortalContactDrawerProps) {
  return (
    <DrawerShell
      open={open}
      onClose={onClose}
