/**
 * PortalSiteDrawer — drawer read-only per le sedi del portale AUSL BO.
...
export type PortalSiteDetail = SiteReadDetail

export interface PortalSiteDrawerProps {
  open: boolean
  onClose: () => void
  detail: PortalSiteDetail | null
...
export default function PortalSiteDrawer({
  open,
  onClose,
  detail,
  selectedId,
