...
from servicenow.api import ServiceNowCaseViewSet, ServiceNowCaseTypeViewSet, SnTechnicianAbsenceViewSet
...
router.register(r"servicenow-technician-absences", SnTechnicianAbsenceViewSet, basename="sn-technician-absence")
...
urlpatterns = [
    ...
    path("api/changelog/dismiss/", ChangelogDismissView.as_view()),
